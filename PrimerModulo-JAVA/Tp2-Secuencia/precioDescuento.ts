...
const precioProducto :number = Number(readlineSync.question("Ingrese el Precio del Producto: "));
//  let precioProducto :number = readlineSync.question.Int("Ingrese el Precio del Producto: ");
const descuento :number = precioProducto * 0.1;

const precioFinal : number = precioProducto - descuento;
