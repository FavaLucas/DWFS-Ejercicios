...
var operarios = ["Andres", "Marianela", "Sandra", "Marcos", "Adriana"];
var produccionSemanal = [
...
//----------------------------------------------Ejercicio A , B, C y D------------------------------------------------ 
function Produccion(arreglo) {
    var retorno = new Array(2);
    var sumaSemana = 0;
    var arregloMes = new Array(3);
    var mes = 0;
    ...
    for (var semana = 0; semana < arreglo.length; semana++) {
        ...
        if (semana == 3 || semana == 7 || semana == 11) {
            if (semana == 3) {
                ...
                var produccionMaxima = 0;
                var indiceMaximo = 0;
                for (var indice = 4; indice < 8; indice++) {
                    if (produccionMaxima < arreglo[indice]) {
                        produccionMaxima = arreglo[indice];
                        indiceMaximo = indice + 1;
                    }
                ...
                var produccionMaxima = 0;
                var indiceMaximo = 0;
                for (var indice = 8; indice < 12; indice++) {
                    if (produccionMaxima < arreglo[indice]) {
                        produccionMaxima = arreglo[indice];
                        indiceMaximo = indice + 1;
                    }
...
for (var operario = 0; operario < produccionSemanal.length; operario++) {
