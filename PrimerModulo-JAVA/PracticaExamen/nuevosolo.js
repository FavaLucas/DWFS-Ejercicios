...
var trabajadores = ["Andres", "Marianela", "Sandra", "Marcos", "Adriana"];
...
function promedioSemanalProduccion(arreglo) {
    var produccionSemanal = 0;
    for (var semana = 0; semana < arreglo.length; semana++) {
...
function promedioMensualProduccion(arreglo) {
    var promMensual = new Array(3);
    promMensual = [0, 0, 0];
...
function ventaMaximaSYM(arreglo) {
    var mes = new Array(3);
...
function determinarPremios(arreglo) {
    var promMensual = new Array(3);
    promMensual = [0, 0, 0];
    promMensual[0] = arreglo[0] + arreglo[1] + arreglo[2] + arreglo[3] / 4;
    promMensual[1] = arreglo[4] + arreglo[5] + arreglo[6] + arreglo[7] / 4;
    promMensual[2] = arreglo[8] + arreglo[9] + arreglo[10] + arreglo[11] / 4;
    for (var mes = 0; mes < promMensual.length; mes++) {
...
function premiosMensuales(arreglo) {
    var prodMensual = new Array(3);
    prodMensual = [0, 0, 0];
    var premiosMensual = new Array(3);
    ...
    for (var fila = 0; fila < arreglo.length; fila++) {
        ...
        for (var mes = 0; mes < prodMensual.length; mes++) {
...
function evaluarSemanas(matriz, arreglo) {
    //El for va a dejar fija la columna por que se va a evaluar a todos los operadores en la misma semana
    console.log(matriz);
    for (var semana = 0; semana < matriz.length; semana++) {
        for (var operador = 0; operador < matriz[semana].length; operador++) {
